...
async function generateReceipt(order, outputPath = null) {
    return new Promise((resolve, reject) => {
        try {
            ...
            // Delivery Address
            doc.fontSize(12).fillColor('#000000').text('Delivery Address:', leftColumn, doc.y);
            ...
            doc.fontSize(9)
                .fillColor('#999999')
                .text('Thank you for your order!', leftColumn, doc.y, {
                    align: 'center',
                    width: 495,
                })
                .moveDown(0.3)
                .text(
                    'For questions or support, contact us at support@hometowndelivery.com',
                    leftColumn,
                    doc.y,
                    { align: 'center', width: 495 }
                )
                .moveDown(0.3)
                .text('Visit us at www.hometowndelivery.com', leftColumn, doc.y, {
                    align: 'center',
                    width: 495,
                });
